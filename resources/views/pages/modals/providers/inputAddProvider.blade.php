...
<div class="form-group col-12 col-md-8 mb-3">
    ...
    <input name="document" type="number" class="form-control" id="inputAggDocument" required minlength="7"
        maxlength="12" value="{{ old('document') }}">
...
<div class="form-group col-12 col-md-6 mb-3">
    ...
    <input name="phone" type="number" class="form-control" id="inputAggPhone" minlength="10" maxlength="12"
        value="{{ old('phone') }}">
